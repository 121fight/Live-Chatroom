...
let isMicMutedLocal = true; // Tracks the mic mute state correctly
...
window.AgoraVoice = {
    ...
    publishAudio: async function() {
        try {
            // High Quality Voice Setup with Echo Cancellation
    ...
    toggleMic: async function() {
        ...
        return isMicMutedLocal; // Returns true if it became muted, false if unmuted
    },
