const app = {
    ...
    enterRoom: async function(roomId, title, hostId, isCreating = false) {
        ...
        this.playBeep(800); // Play Join sound
    ...
    toggleMic: async function() {
        ...
        // Update Firebase to show UI to everyone
    ...
    exitRoom: async function() {
        ...
        this.playBeep(300); // Play Leave sound
